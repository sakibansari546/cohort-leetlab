const verificationEmailTemplate = (username, verificationURL) => {
  return {
    body: {
      name: username,
      intro:
        "Welcome to Hypecoging! We're thrilled to have you join our community of coding enthusiasts.",
      action: {
        instructions:
          "To get started with Hypecoging, please verify your email by clicking the button below:",
        button: {
...
const forgotPasswordEmailTemplate = (username, verificationURL) => {
  return {
    body: {
      name: username,
      intro:
        "Forgot your password? No worries, we've got you covered at Hypecoging.",
      action: {
